    ...
    <div className="min-h-screen flex items-center justify-center p-4 md:p-6">
      ...
      >
        <GlassMorphicBox>
          <div className="text-center">
            ...
            <div className="mb-6">
              <input
                ...
                className="w-full max-w-[400px] px-4 py-3 bg-white/5 border border-white/20 rounded-full text-white placeholder-white/40 focus:outline-none focus:border-white/40"
              />
              {error && (
          ...
          <button
            onClick={handleStart}
            className="w-full mt-4 py-3 px-6 bg-transparent border border-white/20 rounded-full text-white hover:bg-white/5 transition-colors"
          >
            Start my journey
          </button>
        </GlassMorphicBox>
